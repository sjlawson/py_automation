...
class HowItWorksThunderballPageSegmentTestCase(SeleniumTestCase):
    ...
    # def test_howItWorksTballSegmentPagecall(self):
    ...
    # test segment call on clicking the join link in the header - Thunderabll version
    ...
    def test_howItWorksTballHeaderLinkClick(self):
        ...
        segcall_info = {
            ...
            'segment_params': [
                ...
                ('activityLocation', 'How it Works link in header'),
            ]
        }
