...
## Header Segment Events - Company List ##
    ...
    def test_testCompanyListSegmentJoin(self):
        ...
        collect_seg_calls = SegmentTestHelper.gather_segment_requests_for_url(self, '/edit?serviceProviderId=10803144', 'div.col-xs-12 > div.workComplete > label.work-complete > div.form-group > div.btn-group > #reviews--workComplete-button-yes]', 'click')
